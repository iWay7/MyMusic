...
public final class Constants {
    ...
    public static final String ALBUM_URL_BASE = SERVICE_URL_BASE + "GetAlbum?fileName=";
    ...
    public static final String EV_ALBUM_CHANGED = "EV_ALBUM_CHANGED";
    ...
    public static final String EV_REQUEST_REFRESH_PLAY_LIST = "EV_REQUEST_REFRESH_PLAY_LIST";
